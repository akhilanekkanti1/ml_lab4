...
```{r}
# not sure if this is correct, but its in my notes
#Bagged tree models split at the same root variable (most important predictor) - both use bootstrap aggregation (averages all the models)
#Random forest models split at random root variables.
